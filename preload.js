...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  toggleUndetectability: () => ipcRenderer.invoke('toggle-undetectability'),
  toggleAudioChannel: (channel) => ipcRenderer.invoke('toggle-audio-channel', channel),
  ...
  toggleTranscript: () => ipcRenderer.invoke('toggle-transcript'),
  closeTranscript: () => ipcRenderer.invoke('close-transcript'),
  saveMeeting: (opts) => ipcRenderer.invoke('save-meeting', opts),
  getKeybinds: () => ipcRenderer.invoke('get-keybinds'),
  setKeybind: (id, accelerator) => ipcRenderer.invoke('set-keybind', { id, accelerator }),
  suspendShortcuts: (suspended) => ipcRenderer.invoke('suspend-shortcuts', suspended),
  getDeepgramStatus: () => ipcRenderer.invoke('get-deepgram-status'),
  setDeepgramKey: (key) => ipcRenderer.invoke('set-deepgram-key', key),
  submitGoogleAuthCode: (code) => ipcRenderer.invoke('submit-google-auth-code', code),
  ...
  onUserMessage: (callback) => ipcRenderer.on('user-message', callback),
  onShowHistory: (callback) => ipcRenderer.on('show-history', callback),
  onMeetingSaved: (callback) => ipcRenderer.on('meeting-saved', callback),
