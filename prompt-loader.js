    ...
    try {
      ...
      for (const file of files) {
        if (file.endsWith('.md')) {
          ...
          // 'general' is the default private assistant; keep 'dsa' for when the
          // user explicitly wants competitive-coding answers.
          if (skillName !== 'general' && skillName !== 'dsa') continue;
